...
#line 62 "..\\..\\..\\inc/hw_i2s.h"
                                            
#line 69 "..\\..\\..\\inc/hw_i2s.h"
...
#line 39 "..\\drivers\\sound.c"
#line 1 "..\\..\\..\\driverlib/i2s.h"
...
#line 65 "..\\..\\..\\driverlib/i2s.h"



#line 75 "..\\..\\..\\driverlib/i2s.h"
...
#line 96 "..\\..\\..\\driverlib/i2s.h"

#line 104 "..\\..\\..\\driverlib/i2s.h"
...
#line 41 "..\\drivers\\sound.c"
#line 42 "..\\drivers\\sound.c"
...
SoundInit(void)
{
    ...
    ((void (*)(unsigned long ulPeripheral))((unsigned long *)(((unsigned long *)0x01000010)[13]))[6])(0x10101000);
    ((void (*)(unsigned long ulPeripheral))((unsigned long *)(((unsigned long *)0x01000010)[13]))[6])(0x20002000);
    ...
    GPIOPinConfigure(0x00011809);
    GPIOPinConfigure(0x00041009);
    GPIOPinConfigure(0x00041409);
    GPIOPinConfigure(0x00050408);

    
    
    
    ((void (*)(unsigned long ulPeripheral))((unsigned long *)(((unsigned long *)0x01000010)[13]))[6])((0x20000002));
    GPIOPinTypeI2S((0x40005000), (0x00000040));

    ((void (*)(unsigned long ulPeripheral))((unsigned long *)(((unsigned long *)0x01000010)[13]))[6])((0x20000020));
    GPIOPinTypeI2S((0x40025000), (0x00000002));

    ((void (*)(unsigned long ulPeripheral))((unsigned long *)(((unsigned long *)0x01000010)[13]))[6])((0x20000010));
    GPIOPinTypeI2S((0x40024000), (0x00000010));

    ((void (*)(unsigned long ulPeripheral))((unsigned long *)(((unsigned long *)0x01000010)[13]))[6])((0x20000010));
    GPIOPinTypeI2S((0x40024000), (0x00000020));

    
    
    
    ((void (*)(void *pControlTable))((unsigned long *)(((unsigned long *)0x01000010)[17]))[8])(&sDMAControlTable[0]);
    ((void (*)(void))((unsigned long *)(((unsigned long *)0x01000010)[17]))[1])();
    ...
    I2STxFIFOLimitSet(0x40054000, 4);

    
    
    
    I2SIntClear(0x40054000, 0x00000002 | 0x00000001 );

    
    
    
    ((void (*)(unsigned long ulChannelNum, unsigned long ulAttr))((unsigned long *)(((unsigned long *)0x01000010)[17]))[12])(29, 0x0000000F);

    
    
    
    I2STxEnable(0x40054000);
}
...
SoundIntHandler(void)
{
    ...
    ulStatus = I2SIntStatus(0x40054000, 1);

    
    
    
    I2SIntClear(0x40054000, ulStatus);

    
    
    
    if((*((volatile unsigned long *)(((unsigned long)(&g_ulDMAFlags) & 0xF0000000) | 0x02000000 | (((unsigned long)(&g_ulDMAFlags) & 0x000FFFFF) << 5) | ((1) << 2)))))
    {
        
        
        
        if(((unsigned long (*)(unsigned long ulChannelStructIndex))((unsigned long *)(((unsigned long *)0x01000010)[17]))[16])(29 | 0x00000000) ==
           0x00000000)
        {
            ...
            {
                g_sOutBuffers[0].pulData = 0;
                g_sOutBuffers[0].pfnBufferCallback(pulTemp, 0x00000001);
            }
        }
        ...
        if(((unsigned long (*)(unsigned long ulChannelStructIndex))((unsigned long *)(((unsigned long *)0x01000010)[17]))[16])(29 | 0x00000020) ==
           0x00000000)
        {
            ...
            {
                g_sOutBuffers[1].pulData = 0;
                g_sOutBuffers[1].pfnBufferCallback(pulTemp, 0x00000001);
            }
        }
        ...
        {
            (*((volatile unsigned long *)(((unsigned long)(&g_ulDMAFlags) & 0xF0000000) | 0x02000000 | (((unsigned long)(&g_ulDMAFlags) & 0x000FFFFF) << 5) | ((1) << 2)))) = 0;
        }
    }
}
               ...
               unsigned short usChannels)
{
    ...
    I2SMasterClockSelect(0x40054000, 0x00000000);

    
    
    
    ulFormat = 0x14000000 | 0x00400000;

    
    
    
    if((((*((volatile unsigned long *)(0x400FE000))) & (0x70000000 | 0x00FF0000)) == (0x10000000 | 0x00040000)) && (((*((volatile unsigned long *)(0x400FE000))) & (0x0000FF00 | 0x000000FF)) == (0x00000100 | 0x00000001)))
    {
        ulI2SErrata = 1;
    }
    else
    ...
    if(g_usChannels == 1)
    {
        ...
        if(g_usBitsPerSample == 8)
        {
            ...
            {
                ulFormat |= 0x000001F0 | 0x02000000 |
                            0x00001C00;
                usBitsPerSample = 32;
            }
            else
            {
                ulFormat |= 0x00000070 | 0x02000000 |
                            0x00001C00;
            }
        }
        ...
        else if(g_usBitsPerSample == 16)
        {
            ...
            {
                ulFormat |= 0x000000F0 | 0x02000000 |
                            0x00003C00;
            }
        }
        ...
        {
            ulFormat |= 0x00000170 | 0x02000000 |
                        0x00005C00;
        }
        else
        {
    ...
    else
    {
        ...
        {
            ulFormat |= 0x00000170 | 0x00000000 |
                        0x00005C00;
        }
        else
        {
            ulFormat |= 0x000001F0 | 0x00000000 |
                        0x00007C00;
        }
    }
    ...
    I2STxConfigSet(0x40054000, ulFormat);
    ...
    ((void (*)(unsigned long ulChannelNum, unsigned long ulAttr))((unsigned long *)(((unsigned long *)0x01000010)[17]))[11])(29,
                                   (0x00000001 |
                                    0x00000004));
    ...
    if(g_usChannels == 1)
    {
        ...
        if(g_usBitsPerSample == 8)
        {
            ...
            ulDMASetting = 0x00000000 | 0x00000000 |
        ...
        else
        {
            ...
            ulDMASetting = 0x11000000 | 0x04000000 |
                           0xc0000000 | 0x00004000;
        }
    }
    else
    {
        ...
        else
        {
            ...
            ulDMASetting = 0x22000000 | 0x08000000 |
                           0xc0000000 | 0x00004000;
        }
    }
    ...
    ((void (*)(unsigned long ulChannelStructIndex, unsigned long ulControl))((unsigned long *)(((unsigned long *)0x01000010)[17]))[14])(29 | 0x00000000,
                              ulDMASetting);
    ((void (*)(unsigned long ulChannelStructIndex, unsigned long ulControl))((unsigned long *)(((unsigned long *)0x01000010)[17]))[14])(29 | 0x00000020,
                              ulDMASetting);
}
                ...
                void (*pfnCallback)(void *pvBuffer, unsigned long ulEvent))
{
    ...
    ((void (*)(unsigned long ulInterrupt))((unsigned long *)(((unsigned long *)0x01000010)[14]))[3])(68);
    ...
    if(g_ulPlaying)
    {
        ulChannel = 29 | 0x00000020;
    }
    else
    {
        ulChannel = 29 | 0x00000000;
    }
    ...
    ((void (*)(unsigned long ulChannelStructIndex, unsigned long ulMode, void *pvSrcAddr, void *pvDstAddr, unsigned long ulTransferSize))((unsigned long *)(((unsigned long *)0x01000010)[17]))[0])(ulChannel,
                           0x00000003,
                           (unsigned long *)g_sOutBuffers[g_ulPlaying].pulData,
                           (void *)(0x40054000 + 0x00000000),
    ...
    ((void (*)(unsigned long ulChannelNum))((unsigned long *)(((unsigned long *)0x01000010)[17]))[5])(29);

    
    
    
    (*((volatile unsigned long *)(((unsigned long)(&g_ulDMAFlags) & 0xF0000000) | 0x02000000 | (((unsigned long)(&g_ulDMAFlags) & 0x000FFFFF) << 5) | ((1) << 2)))) = 1;
    ...
    ((void (*)(unsigned long ulInterrupt))((unsigned long *)(((unsigned long *)0x01000010)[14]))[0])(68);
}
