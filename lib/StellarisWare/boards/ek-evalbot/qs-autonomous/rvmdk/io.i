...
static unsigned char g_ucDebouncedButtons = 0x00000040 | 0x00000080;
...
PushButtonsInit (void)
{
    ...
    ((void (*)(unsigned long ulPort, unsigned char ucPins))((unsigned long *)(((unsigned long *)0x01000010)[4]))[14])(0x40007000, 0x00000040 | 0x00000080);
    ((void (*)(unsigned long ulPort, unsigned char ucPins, unsigned long ulStrength, unsigned long ulPadType))((unsigned long *)(((unsigned long *)0x01000010)[4]))[5])(0x40007000, 0x00000040 | 0x00000080,
...
PushButtonDebouncer(void)
{
    ...
    ucData = ((long (*)(unsigned long ulPort, unsigned char ucPins))((unsigned long *)(((unsigned long *)0x01000010)[4]))[11])(0x40007000, 0x00000040 | 0x00000080);
...
tBoolean  PushButtonGetStatus (tButton eButton)
{
    ...
    switch (eButton)
    {
        ...
        case BUTTON_1:
        {
            status = ((long (*)(unsigned long ulPort, unsigned char ucPins))((unsigned long *)(((unsigned long *)0x01000010)[4]))[11])(0x40007000, 0x00000040) ?
                                     1 : 0;
            break;
        }
        ...
        case BUTTON_2:
        {
            status = ((long (*)(unsigned long ulPort, unsigned char ucPins))((unsigned long *)(((unsigned long *)0x01000010)[4]))[11])(0x40007000, 0x00000080) ?
                                     1 : 0;
            break;
        }
...
tBoolean  PushButtonGetDebounced(tButton eButton)
{
    ...
    switch (eButton)
    {
        ...
        case BUTTON_1:
        {
            status = g_ucDebouncedButtons & 0x00000040 ? 1 : 0;
            break;
        }
        ...
        case BUTTON_2:
        {
            status = g_ucDebouncedButtons & 0x00000080 ? 1 : 0;
            break;
        }
...
LED_On(tLED eLED)
{
    ...
    switch (eLED)
    {
        ...
        case LED_1:
        {
            ((void (*)(unsigned long ulPort, unsigned char ucPins, unsigned char ucVal))((unsigned long *)(((unsigned long *)0x01000010)[4]))[0])(0x40025000, 0x00000010, 0x00000010);
            break;
        }
        ...
        case LED_2:
        {
            ((void (*)(unsigned long ulPort, unsigned char ucPins, unsigned char ucVal))((unsigned long *)(((unsigned long *)0x01000010)[4]))[0])(0x40025000, 0x00000020, 0x00000020);
            break;
        }
...
LED_Off (tLED eLED)
{
    ...
    switch (eLED)
    {
        ...
        case BOTH_LEDS:
        {
            ((void (*)(unsigned long ulPort, unsigned char ucPins, unsigned char ucVal))((unsigned long *)(((unsigned long *)0x01000010)[4]))[0])(0x40025000, 0x00000010 | 0x00000020, 0);
            break;
        }
        ...
        case LED_1:
        {
            ((void (*)(unsigned long ulPort, unsigned char ucPins, unsigned char ucVal))((unsigned long *)(((unsigned long *)0x01000010)[4]))[0])(0x40025000, 0x00000010, 0);
            break;
        }
        ...
        case LED_2:
        {
            ((void (*)(unsigned long ulPort, unsigned char ucPins, unsigned char ucVal))((unsigned long *)(((unsigned long *)0x01000010)[4]))[0])(0x40025000, 0x00000020, 0);
            break;
        }
...
LED_Toggle (tLED eLED)
{
    ...
    switch (eLED)
    {
        ...
        case LED_1:
        {
            ((void (*)(unsigned long ulPort, unsigned char ucPins, unsigned char ucVal))((unsigned long *)(((unsigned long *)0x01000010)[4]))[0])(0x40025000, 0x00000010,
                             ~((long (*)(unsigned long ulPort, unsigned char ucPins))((unsigned long *)(((unsigned long *)0x01000010)[4]))[11])(0x40025000, 0x00000010));
            break;
        }
        ...
        case LED_2:
        {
            ((void (*)(unsigned long ulPort, unsigned char ucPins, unsigned char ucVal))((unsigned long *)(((unsigned long *)0x01000010)[4]))[0])(0x40025000, 0x00000020,
                             ~((long (*)(unsigned long ulPort, unsigned char ucPins))((unsigned long *)(((unsigned long *)0x01000010)[4]))[11])(0x40025000, 0x00000020));
            break;
        }
