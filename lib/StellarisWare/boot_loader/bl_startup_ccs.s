...
Vectors:
 ...
 .if $$defined(FLASH_PATCH_COMPATIBLE)
    .word   UpdateHandler - 0x1ffff000      ;; Offset 2C: SVCall handler
 .else
 ...
 .endif
 .if ($$defined(USB_ENABLE_UPDATE) | (APP_START_ADDRESS != VTABLE_START_ADDRESS) | $$defined(FLASH_PATCH_COMPATIBLE))
 ...
 .if $$defined(FLASH_PATCH_COMPATIBLE)
    .word   0x00000881                      ;; Offset B4: FLASH Control
 .else
